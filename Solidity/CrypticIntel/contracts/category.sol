...
contract ERC721PresetMinterPauserAutoId is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Pausable {
    ...
    constructor(string memory name, string memory symbol, string memory baseTokenURI, uint256 maxBatchSize, uint256 collectionSize, string memory category) ERC721(name, symbol, maxBatchSize, collectionSize, category) {       _baseTokenURI = baseTokenURI;
...
contract Airdrop is ERC721PresetMinterPauserAutoId {
    ...
    constructor(uint256 _maxBatchSize, uint256 _collectionSize, string memory _category) ERC721PresetMinterPauserAutoId("Name", "kunai", "https://drive.google.com/uc?id=1NeYsNAPQuxWXSUzFf_xIU5q8n1llBgjv", _maxBatchSize, _collectionSize, _category) {}
